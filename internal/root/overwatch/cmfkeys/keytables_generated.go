...
// builtinKeytableCount is the number of ported builds (179).
const builtinKeytableCount = 179

// builtinKeytables maps build number to its 512-byte CMF keytable.
var builtinKeytables = map[uint32][512]byte{
	35328: {
